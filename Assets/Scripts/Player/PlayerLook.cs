...
public class PlayerLook : MonoBehaviour
{
    ...
    private void CameraLogic()
    {
        ...
        _camLookX -= Input.GetAxis("Mouse Y") * SettingsHolder.Data.MouseSensitivity * Time.deltaTime;
        _camLookY = Input.GetAxis("Mouse X") * SettingsHolder.Data.MouseSensitivity * Time.deltaTime;
    ...
    private void Cinematics()
    {
        ...
        _targetFOV = Input.GetKey(SettingsHolder.Data.RunKey) ?
